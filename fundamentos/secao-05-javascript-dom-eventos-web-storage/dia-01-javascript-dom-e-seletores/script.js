...
// Escreva uma função que muda a cor do background da página.
// document.querySelector('.month-container').style.backgroundColor = 'blue';
// alteraCor('.month-container', 'blue');
// alteraCor('.month-container', 'magenta');
// alteraCor('.month-container', 'yellow');
// alteraCor('#btn-holiday', 'yellow');
